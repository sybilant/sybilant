...
testcase:
    ...
    ASSERT_EQ qword [r12 + SYBILANT_ATOM_TYPE_TYPE_OFFSET], SYBILANT_TYPE_TYPE, "sybilant/type should return a type value for an atom"
    ASSERT_EQ qword [r12 + SYBILANT_ATOM_TYPE_CONSTRUCTOR_OFFSET], SYBILANT_ATOM_TYPE_CONSTRUCTOR, "sybilant/type should return an atom type"
