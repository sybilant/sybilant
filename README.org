...
** Roadmap
   ...
   - [ ] version 0.7
     ...
     - [ ] parse label tag
     - [ ] associate tags with literals at parse-time
     - [ ] richer tag equality
       - [ ] number tag in the right range should be equal to a number with
         specific size
     - [ ] analyze defasm form
       ...
       - [ ] check tag for local untagged basic blocks
         ...
         - [ ] continue to next untagged basic block in order
         - [ ] don't follow to next block when the block ends in an
           unconditional jump
